 ...
 */
@Configuration
@ComponentScan({"za.co.mahadew.damien.services.impl","za.co.mahadew.damien.lifecycle"}) //This creates the beans in the folder with annotation @Component or any derived form of @component
